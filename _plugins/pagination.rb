# this was copied in from jekyll-0.11.0

module Jekyll

  class Page
    # need to monkey-patch this in, unless my https://github.com/mojombo/jekyll/pull/415 gets
    # merged in someday
    attr_accessor :dir
  end
  ...
  class Pager
    ...
    def self.pagination_enabled?(config, page)
      page.name == 'index.html' && !config['paginate'].nil? && (config['pagination_roots'].nil? || config['pagination_roots'].index(page.dir))
    end
