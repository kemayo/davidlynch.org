# This is https://github.com/LawrenceWoodman/related_posts-jekyll_plugin but
# switched to using tags instead of categories.
    ...
    posts.each do |post|
      post.tags.each do |tag|
        if self.tags.include?(tag) && post != self
          tag_freq = Jekyll::Post.tag_freq(posts)[tag]
